...
Object_tracking(yolo, video_path, "track2.mp4", input_size=YOLO_INPUT_SIZE, show=False, iou_threshold=0.1, rectangle_colors=(255,0,0), Track_only = ["car", "bus"])
